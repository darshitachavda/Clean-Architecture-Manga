...
namespace Manga.Infrastructure.EntityFrameworkDataAccess.Migrations
{
    ...
    [Migration("20190708142212_Initial")]
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 8, 14, 22, 11, 388, DateTimeKind.Utc).AddTicks(8149)
                        });
                });
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Debit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("4c510cfe-5d61-4a46-a3d9-c4313426655f"),
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 8, 14, 22, 11, 389, DateTimeKind.Utc).AddTicks(1204)
                        });
                });
